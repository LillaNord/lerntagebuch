...
### Anmerkungen: 
- CodiMD wird in HedgeDoc umbenannt... als erstes kommt mir direkt ein :hedgehog: in den Sinn (hedgehog).
...
GitHub ist eine Onlineplattform.

Übung: Link zum Lerntagebuch ergänzen

Fork = Abspaltung
pull request = Anfrage an Dozent damit in sein Repository übernehmen
